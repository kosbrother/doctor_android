...
import kosbrother.com.doctorguide.fragments.dummy.DummyContent.DummyHospital;
...
public class MyHospitalRecyclerViewAdapter extends RecyclerView.Adapter<MyHospitalRecyclerViewAdapter.ViewHolder> {
    ...
    public MyHospitalRecyclerViewAdapter(List<DummyContent.DummyHospital> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
